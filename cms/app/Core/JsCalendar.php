...
class JsCalendar
{
    public function calendar()
    {
		...
		$fmt = (Session::userdata('time_format') != '') ? Session::userdata('time_format') : Site::config('time_format');
