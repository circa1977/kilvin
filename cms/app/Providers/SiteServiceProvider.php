    ...
    public function boot()
    {
        ...
        try {
            ...
            elseif (
                ...
                is_numeric(Request::cookie('cp_last_domain_id')))
            {
                Site::loadDomainPrefs(Request::cookie('cp_last_domain_id'));
            } else {
        ...
        if (!isset($theme_path)) {
            $theme_path = substr(SYSTEM_PATH, 0, - strlen($cms_folder.'/')).'/public/themes/';
